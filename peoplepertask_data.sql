...
INSERT INTO `freelancers` (`id`, `freelancer_name`, `skill`, `salary`, `user_id`) VALUES
(3, 'mehdi', 'developper', 70000, NULL),
(4, 'nada', 'developper', 300000, NULL),
(5, 'mehdi', 'CSS', 700000000, NULL),
(6, 'nada', 'web designer', 300000000, NULL);
...
(2, 'dropshipping', 'Drop shipping is a retail ', 1, 19),
(3, 'sport', 'Sport is commonly defined as an athletic activity that involves a degree', 1, 2),
(4, 'back-end app', 'A back-end application or program supports front-end user services, ', 1, 3),
(5, 'front-end website', 'element that the user has the ability to use, see, and interact with through buttons, images, ', 1, 22);
...
(10, 'je suis satisfaite !', NULL),
(14, 'chui pas satisfaite', NULL),
(16, 'je suis satisfaite !', NULL);
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `region_id`) VALUES
(1, 'malak', 'elmahfoudimalak@gmail.com', 'byhszjnaqkjQHVGTZ', NULL);
...
--
ALTER TABLE `offers`
  ADD CONSTRAINT `offers_ibfk_1` FOREIGN KEY (`freelancer_id`) REFERENCES `freelancers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

...
--
-- Host: localhost:3306
-- Generation Time: Dec 09, 2023 at 09:56 AM
...
INSERT INTO `categories` (`id`, `categoryName`, `categorie_id`) VALUES
(1, 'sport', NULL),
(2, 'education', NULL),
(3, 'front-end', NULL),
(5, 'back-end', NULL);
...
INSERT INTO `offers` (`id`, `montant`, `deadline`, `status`, `user_id`) VALUES
(1, '10$', '2023-12-09', 'in progress', 17),
(2, '300$', '2023-12-23', 'in progress', 22),
(3, '900', '2023-12-29', 'in progress', 17);
...
INSERT INTO `projects` (`id`, `title`, `description`, `user_id`, `categorie_id`) VALUES
(11, 'app web', 'une application web qui verifie les besoins d utilisateur', NULL, 2),
(12, 'siteWeb', 'Je souhaite un site web moderne et attractif pour présenter mes services de photographie.', NULL, 1),
(14, 'web-site freelance', 'i want a web-site for freelancing', NULL, 3);
...
INSERT INTO `testimonials` (`id`, `comment`, `user_id`) VALUES
(8, 'I just wanted to share a quick note and let you know that you guys do a really good job.', NULL),
(9, ' I\'m glad I decided to work with you.', NULL),
(18, 'test', NULL);
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password`, `role`, `region_id`) VALUES
(17, 'test', 'youcode', 'testyoucode@gmail.com', '$2y$10$24CL2hI/GQTG5ofKipJmEe7E/rM.QMdY4VQdQIzteJHzGY3Tu0EqG', 'freelancer', NULL),
(18, 'try', 'youcode', 'tryyoucode@gmail.com', '$2y$10$JQ7UpjWR3IaaW/QhNk0vYui4VYvU6nvvRSVawLG49kKU.YKFtn21y', 'client', NULL),
(20, 'nada', 'nada', 'nadanada@gmail.com', '$2y$10$Z5LJoDUFkun0FdWoR/Tdv.p0HtW58DXfU8pv8AWfR.cox7WTjY9ui', 'admin', NULL),
(21, 'Nada', 'Elmahfoudi', 'nadaelmahfoudi@gmail.com', '$2y$10$k9gRzLDwGjwsTgIASbvCauibDfhFwTOQt0ts1wleexgTfvAfz901q', 'freelancer', NULL),
(22, 'malak', 'elmahfoudi', 'malakelmahfoudi@gmail.com', '$2y$10$x6UCLGUjrr.dByIG7dsZTuH6NyAgyG69R76peDZzt5rynckkGjA5a', 'freelancer', NULL);
...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `categories_ibfk_1` FOREIGN KEY (`categorie_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `freelancers`
--
ALTER TABLE `freelancers`
  ADD CONSTRAINT `freelancers_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY (`region_id`) REFERENCES `regions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `ville`
--
ALTER TABLE `ville`
  ADD CONSTRAINT `ville_ibfk_1` FOREIGN KEY (`region`) REFERENCES `regions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
